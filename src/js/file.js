...
const $name_size = document.querySelector(
...
$lines.insertAdjacentText(
    "beforeend",
    file.content ? file.content.split("\n").length - 1 : "null",
);

const $commit_title = document.querySelector(
    "main > section > p:nth-of-type(3) > a",
);
...
const $commit_date = document.querySelector(
    "main > section > p:nth-of-type(3) > span",
);

const date = new Date(file.last_commit.created_at);
$commit_date.insertAdjacentText(
    "beforeend",
    timeago({
